            ...
            <section className="w-full px-[300px] h-screen flex justify-center relative">
                <div className="relative">
                    ...
                    <div className="z-10 absolute left-1/2 -translate-x-1/2 -translate-y-[170px] w-[450px]">
                        <div className="py-8 bg-linear-to-b from-zinc-800/70 from-20% to-zinc-950/0 to-60% backdrop-blur-[30px] px-10 rounded-[20px] w-full text-center border-[2px] border-zinc-800 justify-center">
